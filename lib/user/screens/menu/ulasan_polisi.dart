...
import 'package:tanggap_darurat/user/controller/ulasanPolisi_controller.dart';
import 'package:tanggap_darurat/user/models/ulasan_polisi_model.dart';

class UlasanPolisiScreen extends StatelessWidget {
  final String idPolisi;
  UlasanPolisiScreen({required this.idPolisi});

  @override
  Widget build(BuildContext context) {
    final UlasanPolisiController ulasanController = Get.put(UlasanPolisiController());

    ulasanController.fetchUlasan(idPolisi.toString());
        ...
        if (ulasanController.isLoading.value) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              UlasanPolisi ulasan = ulasanController.ulasanList[index];
