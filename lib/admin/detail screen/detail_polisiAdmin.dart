...
class DetailPolisiAdmin extends StatelessWidget {
  final Polisi polisi;

  DetailPolisiAdmin({required this.polisi});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () => Get.to(
                    UlasanPolisiScreen(idPolisi: polisi.idPolisi)),
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    onPressed: () => _openMaps(polisi.linkMaps),
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () => _openCall(polisi.noHp),
